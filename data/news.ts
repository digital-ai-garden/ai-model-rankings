...
export const NEWS_SEED: NewsFile = {
  ...
  items: [
    { date: "2026-08-31", cat: "規制", title: "米商務省、タイ・シンガポール経由の「クラウド抜け穴」規制を検討", body: "米商務省が、中国企業が第三国のNvidia GPUサーバーへ遠隔アクセスしてAIモデルを訓練する手法の規制を検討していると報じられた。物理的なチップの国境越えではなく遠隔利用そのものを対象にする点が新しい。Moonshot AIがタイのサーバーを使ってKimi K3を訓練したとされる事例が具体例として挙げられており、新ルール案は9月初旬にも業界団体へ共有される見通し。", source: "Forbes", url: "https://www.forbes.com/sites/viviantoh/2026/08/31/the-ai-chip-wars-new-front-control-the-cloud-not-the-silicon/" },
