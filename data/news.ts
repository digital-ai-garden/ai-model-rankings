...
export const NEWS_SEED: NewsFile = {
  updated: "2026-09-02T09:00:00+09:00",
  items: [
    { date: "2026-09-01", cat: "リリース", title: "Anthropic、Claude Fable 5.1とMythos 5.1を発表", body: "AnthropicがFable 5・Mythos 5の後継となる5.1版を、初代リリースからわずか3か月で公開した。コーディング・知識労働・長時間タスクでFable 5やOpus 5、GPT-5.6 Solを上回ると発表している。価格は入力$10・出力$50/1Mトークンで据え置きだが、キャッシュ読み取り単価を75%引き下げ、実運用コストは最大45%削減できるという。", source: "Anthropic公式", url: "https://www.anthropic.com/claude-fable-and-mythos-5-1", image: "/news/2026-09-01-fable-5-1.jpg", credit: "イラスト: AI生成（Cloudflare Workers AI）" },
